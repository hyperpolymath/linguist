...
// Replace linguist, Linguist — See README.adoc for details., just run, Linguist started successfully. with actuals
= linguist — Quick Start for Users
:toc:
:toclevels: 2

== What is linguist?

Linguist — See README.adoc for details.
...
----
# Clone and set up
git clone https://github.com/hyperpolymath/linguist.git
cd linguist
just setup
----
...
[source,bash]
----
just install --portable --prefix=./linguist-portable
----
...
* **Wiki**: https://github.com/hyperpolymath/linguist/wiki
