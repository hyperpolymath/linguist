...
// Replace linguist, {{PACKAGE_NAME}}, {{DEPS}} with actuals
= linguist — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining linguist for
...
* Upstream: https://github.com/hyperpolymath/linguist/issues
